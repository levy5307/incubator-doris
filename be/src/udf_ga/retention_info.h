...
static const uint8_t kRetentionEventCount = kRetentionRowCount;  // TODO(yingchun): optmize
static const uint16_t kSameEventIndex = kRetentionEventCount * kRetentionEventCellSize;
